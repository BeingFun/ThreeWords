...
class MyWindow(QMainWindow):
    ...
    def createTrayMenu(self):
        ...
        # 创建菜单项
        self.open_text_update = QAction(
            QIcon(self.cur_open_text_icon), "开启文字更新")
    ...
    def refresh_text_icon(self):
        ...
        if enable_update_text is True:
            ...
            FileTools.dump_config("TEXT_SETTING", "OPEN_TEXT_UPDATE", False)
        else:
            enable_update_text = True
            self.cur_open_text_icon = switch_on_icon
            FileTools.dump_config("TEXT_SETTING", "OPEN_TEXT_UPDATE", True)
        self.createTrayMenu()
    ...
    def refresh_image_icon(self):
        ...
        if enable_update_image is True:
            ...
            FileTools.dump_config("IMAGE_SETTING", "OPEN_IMAGE_UPDATE", False)
        else:
            enable_update_image = True
            self.cur_open_image_icon = switch_on_icon
            FileTools.dump_config("IMAGE_SETTING", "OPEN_IMAGE_UPDATE", True)
        self.createTrayMenu()
